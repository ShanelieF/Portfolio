        ...
        <Jumbotron className="bg-transparent ">
            <Container fluid={true}>
                <Row className="justify-content-around">
                    ...
                    <div>
                    The use of the continuous graph increases the effectiveness of the visualisation as the user is able
                    to see the general trends and patterns at a given frame count which would otherwise not be visible through the particle
                    system alone.
                    </div>
