              ...
              <Container fluid={true}>
                  <Row className="justify-content-around">
                      ...
                      <Row id={'bottom'} className="pl-3 pt-5 pb-3" style={{ fontSize:'14px', fontWeight: 'bold'}}>MY ROLE</Row>
                          <p >
                          I was 1/2 people working on the frontend side and my duties included creating the user interface and intergrating the
                      ...
                      <p> This diagram identifies the key pages of the website. This is followed by initial prototype design created
                      for the main pages. The landing page
                      would consist of cards elements which when hovered present more information about the action. </p>
                      <p className="calign">
                      ...
                      <p> Here are a few snapshots of the final product. The images demonstrate dark mode and light mode feature and are
