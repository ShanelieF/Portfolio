              ...
              <Container fluid={true}>
                  <Row className="justify-content-around">
                      ...
                      <h3 style={{ fontSize:'20px', fontWeight: '100'}}>
                          ...
                          The audience chosen for the visualisation is the general public and the visualisation would aim to explore the different patterns and trends of deaths across different countries.
                      ...
                      for the countries. The visualisation created makes it evident that the majority of malaria outspread is in
                      ...
                      This provides quantifiable data and makes the visualisation helpful.
                      </p>
                      <p className="calign">
                      ...
                      <p>The use of the bubble map is very effective as I aimed to compare the death rate across various countries,
