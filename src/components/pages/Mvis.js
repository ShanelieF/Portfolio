              ...
              <Container fluid={true}>
                  <Row className="justify-content-around">
                      ...
                      <h3 style={{ fontSize:'20px', fontWeight: '100'}}>
                          ...
                          would be to explore the different patterns and trends of deaths caused by malaria.
                          ...
                          A bubble map is used for the viuslaisation as it allows to process large amount of numeric
                      ...
                      <p>
                      The reserach consucted for this project inluded identifying looking at data sets that have information on malaria deaths.
                      The key information:
                      </p>
                      ...
                      it is not able to provide any quantifiable data and uthe user is not able to interpret data for countries that are not within
                      the top 10. </p>

                      <Row id={'bottom'} className="pl-3 pt-5 pb-1" style={{ fontSize:'14px', fontWeight: 'bold'}}>DEVELOPMENT</Row>
                      <p>The Geo map is used for the development as this class allows for a higher level of detail to be added to the map. Geo map allows for the country
                      ...
                      For example in thisillustration I hovered over Nigeria and as seen in the box, it reveals details about the country name and the death count for that specific country.
                      ...
                      <p>This is an image of the final visualisation. It is an interactive visulastion so data is given when user hover over a country.
                      </p>
                      <p className="calign">
                      ...
                      <p>The use of the bubble map is also very effective as my aim was to compare the death rate across various countries,
